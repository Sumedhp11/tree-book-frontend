    ...
    <div>
      <div className="h-full w-full px-3">
        <div className="flex justify-between my-2">
          <div>
            {" "}
            <h1 className=" font-medium text-lg">KB</h1>
          </div>
          <div>
            <Dialog open={openDialog} onOpenChange={setDialog}>
              <DialogTrigger>
                <button className="bg-green-700 p-1 text-lg px-5 rounded-md text-white border border-[#B6B6BE] ">
                  Add +
                </button>
              </DialogTrigger>
              <DialogContent className="h-[90%]">
                <AddKbForm setDialog={setDialog} />
              </DialogContent>
            </Dialog>
          </div>
        </div>
